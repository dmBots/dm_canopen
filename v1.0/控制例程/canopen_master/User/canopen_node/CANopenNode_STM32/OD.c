...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1007_synchronousWindowLength = 0x000C3500,
...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x2000_fast_tpdo_sub0 = 0x04,
    .x2000_fast_tpdo = {0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000},
    .x2001_fast_rpdo_sub0 = 0x04,
    .x2001_fast_rpdo = {0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0x0000000000000000}
};
...
typedef struct {
    ...
    OD_obj_array_t o_2000_fast_tpdo;
    OD_obj_array_t o_2001_fast_rpdo;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2000_fast_tpdo = {
        .dataOrig0 = &OD_RAM.x2000_fast_tpdo_sub0,
        .dataOrig = &OD_RAM.x2000_fast_tpdo[0],
        .attribute0 = ODA_SDO_R,
        .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
        .dataElementLength = 8,
        .dataElementSizeof = sizeof(uint64_t)
    },
    .o_2001_fast_rpdo = {
        .dataOrig0 = &OD_RAM.x2001_fast_rpdo_sub0,
        .dataOrig = &OD_RAM.x2001_fast_rpdo[0],
        .attribute0 = ODA_SDO_R,
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2000, 0x05, ODT_ARR, &ODObjs.o_2000_fast_tpdo, NULL},
    {0x2001, 0x05, ODT_ARR, &ODObjs.o_2001_fast_rpdo, NULL},
