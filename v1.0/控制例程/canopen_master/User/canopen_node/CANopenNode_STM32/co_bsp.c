...
#include "co_stblank.h"
#include "OD.h"

canopen_node_t *canopenNodeSTM32; // It will be set by canopen_app_init and will be used across app to get access to CANOpen objects
...
int
canopen_app_init(canopen_node_t* _canopenNodeSTM32) {
