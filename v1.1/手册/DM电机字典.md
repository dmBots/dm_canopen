...
|              |                                |
| ------------ | ------------------------------ |
| Project File | dm4310_slave.eds               |
| File Version | 1                              |
| Created      | 2024/5/14 11:27:00             |
| Created By   |                                |
| Modified     | 2024/7/30 15:47:00             |
| Modified By  |                                |
...
| 0x03 | Application object 3  | UNSIGNED32 | rw  | no  | no   | 0x60710010    |
...
| 0x03 | Application object 3  | UNSIGNED32 | rw  | no  | no   | 0x60770010    |
| 0x04 | Application object 4  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x05 | Application object 5  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x06 | Application object 6  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
| 0x07 | Application object 7  | UNSIGNED32 | rw  | no  | no   | 0x00000000    |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Highest sub-index supported| UNSIGNED8  | ro  | no  | no   | 0x04          |
| 0x01 | Software ver          | UNSIGNED16 | ro  | no  | no   | 3173          |
| 0x02 | Hardware ver          | UNSIGNED8  | ro  | no  | no   | 3             |
| 0x03 | Voltage max           | UNSIGNED8  | ro  | no  | no   | 30            |
| 0x04 | Current max           | UNSIGNED8  | ro  | no  | no   | 10            |
...
| 0x01 | Rated voltage         | UNSIGNED8  | ro  | no  | no   | 24            |
| 0x02 | Rated current         | UNSIGNED8  | ro  | no  | no   | 7             |
| 0x03 | Rated torque          | UNSIGNED8  | ro  | no  | no   | 3             |
| 0x04 | Rated speed           | UNSIGNED8  | ro  | no  | no   | 120           |
...
| 0x0B | Pa.s                  | UNSIGNED32 | rw  | no  | no   | 0             |
| 0x0C | Jx                    | UNSIGNED32 | rw  | no  | no   | 0x3796FEB5    |
| 0x0D | Pn                    | UNSIGNED8  | rw  | no  | no   | 14            |
| 0x0E | Gr                    | UNSIGNED8  | ro  | no  | no   | 10            |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Highest sub-index supported| UNSIGNED8  | ro  | no  | no   | 0x04          |
| 0x01 | CAN Node-ID           | UNSIGNED8  | rw  | no  | no   | 1             |
| 0x02 | CAN communication speed| UNSIGNED8  | rw  | no  | no   | 8             |
| 0x03 | CANopen sync error    | UNSIGNED8  | rw  | no  | no   | 0             |
| 0x04 | CAN res               | UNSIGNED8  | rw  | no  | no   | 0             |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Highest sub-index supported| UNSIGNED8  | ro  | no  | no   | 0x03          |
| 0x01 | KP                    | UNSIGNED32 | rw  | no  | no   | 0x3F4CCCCD    |
| 0x02 | KI                    | UNSIGNED32 | rw  | no  | no   | 0x3A83126F    |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Highest sub-index supported| UNSIGNED8  | ro  | no  | no   | 0x03          |
| 0x01 | KP                    | UNSIGNED32 | rw  | no  | no   | 0x3B78D8EB    |
| 0x02 | KI                    | UNSIGNED32 | rw  | no  | no   | 0x3D20D97C    |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Highest sub-index supported| UNSIGNED8  | ro  | no  | no   | 0x02          |
| 0x01 | over voltage          | UNSIGNED8  | rw  | no  | no   | 32            |
| 0x02 | under voltage         | UNSIGNED8  | rw  | no  | no   | 15            |
...
| ---- | --------------------- | ---------- | --- | --- | ---- | ------------- |
| 0x00 | Highest sub-index supported| UNSIGNED8  | ro  | no  | no   | 0x02          |
| 0x01 | Clear fault           | UNSIGNED8  | rw  | no  | no   | 0             |
| 0x02 | Save zero             | UNSIGNED8  | rw  | no  | no   | 0             |
