...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1600_RPDOMappingParameter = {
        ...
        .applicationObject1 = 0x20010210,
        .applicationObject2 = 0x20010410,
        .applicationObject3 = 0x20010820,
    ...
    .x1601_RPDOMappingParameter = {
        ...
        .applicationObject1 = 0x20010920,
        .applicationObject2 = 0x20010A20,
    ...
    .x1A00_TPDOMappingParameter = {
        ...
        .applicationObject2 = 0x20010310,
        .applicationObject3 = 0x20010520,
        .applicationObject4 = 0x00000000,
        .applicationObject5 = 0x00000000,
        .applicationObject6 = 0x00000000,
        .applicationObject7 = 0x00000000,
...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x2001_M1 = {
        ...
        .control_word = 0x0000,
        .status_word = 0x0000,
        .mode_operation = 0x0000,
        .mode_operation_display = 0x0000,
        .tor_set = 0,
        .vel_set = 0,
        .pos_set = 0,
        .tor = 0,
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2001_M1 = {
        {
            .dataOrig = &OD_RAM.x2001_M1.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2001_M1.control_word,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x2001_M1.status_word,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x2001_M1.mode_operation,
            .subIndex = 3,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x2001_M1.mode_operation_display,
            .subIndex = 4,
            .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x2001_M1.tor_set,
            .subIndex = 5,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x2001_M1.vel_set,
            .subIndex = 6,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x2001_M1.pos_set,
            .subIndex = 7,
            .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x2001_M1.tor,
            .subIndex = 8,
            .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x2001_M1.vel,
            .subIndex = 9,
            .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x2001_M1.pos,
            .subIndex = 10,
            .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
            .dataLength = 4
        }
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2001, 0x0B, ODT_REC, &ODObjs.o_2001_M1, NULL},
