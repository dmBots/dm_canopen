...
********************************************************************************
    ...
    File info:
        ...
        Created By:   
        Modified:     2024/5/29 16:32:26
        Modified By:  

    Device Info:
        Vendor Name:  
        Vendor ID:    
        Product Name: CIA402_Master
        Product ID:   
...
typedef struct {
    ...
    uint8_t x2000_fast_tpdo_sub0;
    uint64_t x2000_fast_tpdo[OD_CNT_ARR_2000];
    uint8_t x2001_fast_rpdo_sub0;
    uint64_t x2001_fast_rpdo[OD_CNT_ARR_2001];
} OD_RAM_t;
...
#define OD_ENTRY_H2000_fast_tpdo &OD->list[33]
#define OD_ENTRY_H2001_fast_rpdo &OD->list[34]
