...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
{
	...
	if (htim == &htim4) {
		...
		dm4310_ctrl_send(&motor[M1], M1);
		dm4310_ctrl_send(&motor[M2], M2);
		dm4310_ctrl_send(&motor[M3], M3);
		dm4310_ctrl_send(&motor[M4], M4);
		
		dm4310_fbdata(&motor[M1], M1);
		dm4310_fbdata(&motor[M2], M2);
		dm4310_fbdata(&motor[M3], M3);
		dm4310_fbdata(&motor[M4], M4);
	}
}
...
void canopen_init(void)
{
	...
	motor[M1].id = 1;
	motor[M1].ctrl.pos_set = 8.0f;
	motor[M1].ctrl.vel_set = 2.0f;
	motor[M1].ctrl.tor_set = 0.0f;
	motor[M1].ctrl.mode = 2;
	
	motor[M2].id = 2;
	motor[M2].ctrl.pos_set = 10.0f;
	motor[M2].ctrl.vel_set = 2.0f;
	motor[M2].ctrl.tor_set = 0.0f;
	motor[M2].ctrl.mode = 2;
	
	motor[M3].id = 3;
	motor[M3].ctrl.pos_set = 8.0f;
	motor[M3].ctrl.vel_set = 1.0f;
	motor[M3].ctrl.tor_set = 0.0f;
	motor[M3].ctrl.mode = 2;
	
	motor[M4].id = 4;
	motor[M4].ctrl.pos_set = 8.0f;
	motor[M4].ctrl.vel_set = 1.0f;
	motor[M4].ctrl.tor_set = 0.0f;
	motor[M4].ctrl.mode = 2;
